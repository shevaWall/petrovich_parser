                                    ...
                                    <div class="d-flex align-items-start mt-3 mt-sm-0">
                                        <div class="flex-shrink-0">
                                            <div class="avatar-xl me-3">
                                                <img src="{{asset('images/admin/users/avatar-2.jpg')}}" alt=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl">
                                                    <div class="text-muted">
                                                        ...
                                                        <p class="mb-0">It is a long established fact that a reader will
                                                            be distracted by the readable content of a page when looking
                                                            at it has a more-or-less normal distribution of letters</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-xl">
                                                    <div class="text-muted">
                                                        ...
                                                        <ul class="list-unstyled mb-0">
                                                            <li class="py-1">
                                                                <i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>Donec
                                                                vitae sapien ut libero venenatis faucibus
                                                            </li>
                                                            <li class="py-1">
                                                                <i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>Quisque
                                                                rutrum aenean imperdiet
                                                            </li>
                                                            <li class="py-1">
                                                                <i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>Integer
                                                                ante a consectetuer eget
                                                            </li>
                                                            <li class="py-1">
                                                                <i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>Phasellus
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4">
                                                <div class="card p-1 mb-xl-0">
                                                    ...
                                                    <div class="position-relative">
                                                        <img src="{{asset('images/admin/small/img-3.jpg')}}" alt=""
                                                             class="img-thumbnail">
                                                    </div>
                                            ...
                                            <div class="col-xl-4">
                                                <div class="card p-1 mb-xl-0">
                                                    ...
                                                    <div class="position-relative">
                                                        <img src="{{asset('images/admin/small/img-1.jpg')}}" alt=""
                                                             class="img-thumbnail">
                                                    </div>
                                            ...
                                            <div class="col-xl-4">
                                                <div class="card p-1 mb-sm-0">
                                                    ...
                                                    <div class="position-relative">
                                                        <img src="{{asset('images/admin/small/img-5.jpg')}}" alt=""
                                                             class="img-thumbnail">
                                                    </div>
                                            ...
                                            <div class="col-xl-8">
                                                ...
                                                <div>
                                                    <div class="d-flex align-items-start">
                                                        <div class="flex-grow-1 overflow-hidden">
                                                            <h5 class="font-size-14 text-truncate">
                                                                <a href="#" class="text-dark">Beautiful Day with Friends</a></h5>
                                                            <p class="font-size-13 text-muted mb-0">10 Apr, 2020</p>
                                                        </div>
                                                        <div class="flex-shrink-0 ms-2">
                                                            <div class="dropdown">
                                                    ...
                                                    <div class="position-relative mt-3">
                                                        <img src="{{asset('images/admin/small/img-3.jpg')}}" alt="" class="img-thumbnail">
                                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="list-group list-group-flush">
                                <a href="#" class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm flex-shrink-0 me-3">
                                            <img src="{{asset('images/admin/users/avatar-1.jpg')}}" alt=""
                                ...
                                <a href="#" class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm flex-shrink-0 me-3">
                                            <img src="{{asset('images/admin/users/avatar-3.jpg')}}" alt=""
                                                 class="img-thumbnail rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                                            <div>
                                ...
                                <a href="#" class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm flex-shrink-0 me-3">
                                            <div
                                                class="avatar-title bg-soft-light text-light rounded-circle font-size-22">
